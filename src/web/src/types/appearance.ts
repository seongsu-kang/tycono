...
export const DEFAULT_APPEARANCES: Record<string, CharacterAppearance> = {
  ...
  'data-analyst': { skinColor: '#F5CBA7', hairColor: '#3E2723', shirtColor: '#0277BD', pantsColor: '#37474F', shoeColor: '#212121', hairStyle: 'curly', outfitStyle: 'vest', accessory: 'none' },
};
...
export const OFFICE_THEMES: Record<OfficeTheme, ThemeColors> = {
  ...
  light: {
    ...
    vars: {
      ...
      '--terminal-text-secondary': '#484f58',
      '--terminal-text-muted': '#6e7781',
      '--accent': '#0969da',
      '--active-green': '#1a7f37',
      '--idle-amber': '#9a6700',
      '--bar-bg': '#24292f',
