...
export type SystemPrompt = string | Array<{
    type: 'text';
    text: string;
    cache_control?: {
        type: 'ephemeral';
...
export interface LLMProvider {
    chat(systemPrompt: SystemPrompt, messages: LLMMessage[], tools?: ToolDefinition[], signal?: AbortSignal, options?: ChatOptions): Promise<LLMResponse>;
    chatStream?(systemPrompt: SystemPrompt, messages: LLMMessage[], tools: ToolDefinition[] | undefined, callbacks: StreamCallbacks): Promise<LLMResponse>;
}
