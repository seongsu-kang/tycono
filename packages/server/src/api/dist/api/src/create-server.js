...
function handleImportKnowledge(req, res) {
    ...
    req.on('end', () => {
        ...
        const root = body.companyRoot || COMPANY_ROOT;
        res.writeHead(200, {
