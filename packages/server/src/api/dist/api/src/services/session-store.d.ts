import { type ActivityEvent, type SessionSource, type SessionStatus, type MessageStatus } from '../../../shared/types.js';
...
export declare function deleteSession(id: string, force?: boolean): boolean;
