...
import { digest } from '../services/digest-engine.js';
...
supervisionRouter.get('/watch', async (req, res) => {
    ...
    const alertOnParam = req.query.alertOn;
...
supervisionRouter.get('/peers', (req, res) => {
    const waveId = req.query.waveId;
